...
const VMStateDescription vmstate_riscv_cpu = {
    ...
    .fields = (VMStateField[]) {
        ...
        VMSTATE_UINTTL(env.mtirs1, RISCVCPU),    
        VMSTATE_UINTTL(env.mtirs2, RISCVCPU),    
        VMSTATE_UINTTL(env.mtiimm, RISCVCPU),   
        VMSTATE_UINTTL(env.mtird, RISCVCPU),    
        VMSTATE_UINTTL(env.mtirdval, RISCVCPU),    
        VMSTATE_UINTTL(env.mtirdval_valid, RISCVCPU),  
