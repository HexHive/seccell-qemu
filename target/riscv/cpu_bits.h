...
typedef enum RISCVException {
    ...
    RISCV_EXCP_SECCELL_ILL_ADDR = 0x18,
    RISCV_EXCP_SECCELL_ILL_PERM = 0x19,
    RISCV_EXCP_SECCELL_INV_SDID = 0x1a,
    RISCV_EXCP_SECCELL_INV_CELL_STATE = 0x1b,
    RISCV_EXCP_SECCELL_ILL_TGT = 0x1c,
} RISCVException;
